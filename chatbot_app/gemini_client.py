...
def construct_prompt_with_rules_and_kb(user_input, rules, knowledge_base_entries):
    ...
    # Tambahkan entri basis pengetahuan yang relevan (implementasi pencarian sederhana)
    # Untuk implementasi nyata, Anda mungkin memerlukan pencarian vektor atau teknik lain
    # untuk menemukan entri KB yang paling relevan dengan user_input.
    relevant_kb = []
